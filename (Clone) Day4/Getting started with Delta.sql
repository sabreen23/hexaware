...
create schema ssdatabricksdemo.hexaware;

-- COMMAND ----------

create table ssdatabricksdemo.hexaware.demo(id int, name string)

-- COMMAND ----------

-- MAGIC %fs ls dbfs:/mnt/ssadlshexa/raw/

-- COMMAND ----------

create table ssdatabricksdemo.hexaware.demo2(id int, name string, age int) LOCATION 'abfss://raw@ssadlshexa.dfs.core.windows.net/delta/demo2'
