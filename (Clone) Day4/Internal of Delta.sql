...
CREATE TABLE IF NOT EXISTS datamaster.hexaware.people10m (
  id INT,
  firstName STRING,
  middleName STRING,
  lastName STRING,
  ...
  ssn STRING,
  salary INT
) LOCATION 'abfss://raw@datamasterdatabricks.dfs.core.windows.net/delta/people10m'

-- COMMAND ----------

describe history datamaster.hexaware.people10m
...
INsert into datamaster.hexaware.people10m values (1,'a','b','z','M','2024-07-30','123',1000)
...
INsert into datamaster.hexaware.people10m values (2,'a','b','z','M','2024-07-30','123',1000),
...
delete from datamaster.hexaware.people10m where id= 1
...
delete from datamaster.hexaware.people10m where id= 2
...
INsert into datamaster.hexaware.people10m values (5,'a','b','z','M','2024-07-30','123',1000);
INsert into datamaster.hexaware.people10m values (8,'a','b','z','M','2024-07-30','123',1000);
INsert into datamaster.hexaware.people10m values (9,'a','b','z','M','2024-07-30','123',1000);
INsert into datamaster.hexaware.people10m values (27,'a','b','z','M','2024-07-30','123',1000);
INsert into datamaster.hexaware.people10m values (25,'a','b','z','M','2024-07-30','123',1000);
INsert into datamaster.hexaware.people10m values (21,'a','b','z','M','2024-07-30','123',1000);
INsert into datamaster.hexaware.people10m values (21,'a','b','z','M','2024-07-30','123',1000);
INsert into datamaster.hexaware.people10m values (222,'a','b','z','M','2024-07-30','123',1000);
INsert into datamaster.hexaware.people10m values (236,'a','b','z','M','2024-07-30','123',1000);
INsert into datamaster.hexaware.people10m values (26,'a','b','z','M','2024-07-30','123',1000);

-- COMMAND ----------

optimize datamaster.hexaware.people10m
zorder by (id)
...
select * from datamaster.hexaware.people10m version as of 17

-- COMMAND ----------

select * from datamaster.hexaware.people10m timestamp as of '2024-07-30T09:20:51.000+00:00'
